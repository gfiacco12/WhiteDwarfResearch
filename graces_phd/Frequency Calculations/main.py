import numpy as np
from Calculations import Frequency_1PN, Frequency_Tides, fisherMatrix, calculateAmplitude
from const import *
...
def main(freq0, mass1, mass2, dl, t_obs):
    ...
    fisherMatrix(t_obs, calculateAmplitude(10, t_obs), 1.5, freq0, fD_1PN, fDD_1PN)
